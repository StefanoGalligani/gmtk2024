...
namespace sg {
	...
	public:
		...
		void LookAtLocal(glm::vec3 target) {
		...
		void LookAtGlobal(glm::vec3 target) {
		...
		void TranslateGlobal(float x, float y, float z) { View3D::TranslateGlobal(x, y, z); UpdateBias(); }
		void TranslateGlobal(glm::vec3 vec) { View3D::TranslateGlobal(vec); UpdateBias(); }
		void TranslateLocal(float x, float y, float z) { View3D::TranslateLocal(x, y, z); UpdateBias(); }
		void TranslateLocal(glm::vec3 vec) { View3D::TranslateLocal(vec); UpdateBias(); }
		...
		void SetGlobalPosition(float x, float y, float z) { View3D::SetGlobalPosition(x, y, z); UpdateBias(); }
		void SetGlobalPosition(glm::vec3 pos) { View3D::SetGlobalPosition(pos); UpdateBias(); }
